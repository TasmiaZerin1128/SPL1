...
public class secondPage {
    ...
    public void TheSecond(Stage primaryStage) {

        Label headning = new Label("Formulas");
        ...
        Image background = new Image("bg.jpg");
        Pane root = new Pane();
