...
public class About {
    ...
    public void showAbout(Stage primaryStage) throws Exception
    {
        ...
        Image formulaVx = new Image("Vx.png");
        ...
        Image formulaVy = new Image("Vy.png");
        ...
        Image formulaV = new Image("V.png");
        ...
        Image formulaX = new Image("X.png");
        ...
        Image formulaY = new Image("Y.png");
        ...
        Image formulaHm = new Image("Hm.png");
        ...
        Image formulaTm = new Image("Tm.png");
        ...
        Image formulaR = new Image("R.png");
        ...
        root.getChildren().addAll(Ground,back,BtVx,BtVy,BtV,BtX,BtY,BtHm,BtTm,BtR);


        BtVx.setTranslateX(1280);
        BtVx.setTranslateY(100);

        BtVy.setTranslateX(1280);
        BtVy.setTranslateY(180);

        BtV.setTranslateX(1280);
        BtV.setTranslateY(260);

        BtX.setTranslateX(1280);
        BtX.setTranslateY(340);

        BtY.setTranslateX(1280);
        BtY.setTranslateY(420);

        BtHm.setTranslateX(1280);
        BtHm.setTranslateY(500);

        BtTm.setTranslateX(1280);
        BtTm.setTranslateY(590);

        BtR.setTranslateX(1280);
